...
def setup(mocker):
    mocker.patch.object(AuthenticationService, '_AuthenticationService__set_credentials').return_val = None
    ...
    mocker.patch.object(YahooFantasyApi, '_YahooFantasyApi__check_tokens').return_val = None
