...
from yfantasy_api.models.helpers import as_int
...
class Add(Transaction):
    def __init__(self, json):
        ...
        self.__parse_transaction_data(
            json[1]["players"]["0"]["player"][1]["transaction_data"][0]
        )
...
class Drop(Transaction):
    def __init__(self, json):
        ...
        self.__parse_transaction_data(
            json[1]["players"]["0"]["player"][1]["transaction_data"]
        )
